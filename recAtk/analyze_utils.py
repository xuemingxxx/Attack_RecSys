...
def load_gpt_fewshot_baseline_trainer(
    ...
    from recAtk.trainers_baseline import FewshotInversionTrainer
...
def load_jailbreak_baseline_trainer(
    ...
    from recAtk.trainers_baseline import JailbreakPromptTrainer
...
def load_seq2seq_baseline_trainer(
    ...
    from recAtk.trainers_baseline import DecodeInversionTrainer
