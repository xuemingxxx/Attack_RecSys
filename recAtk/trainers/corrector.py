...
from recAtk.models import CorrectorEncoderModel
from recAtk.models.model_utils import freeze_params
from recAtk.run_args import TrainingArguments
from recAtk.utils import dataset_map_multi_worker
...
class Corrector(BaseTrainer):
    ...
    def _preprocess_dataset_hypotheses(
        ...
        # during testing.
        cache_dir = os.environ["recAtk_CACHE"]
