...
Currently, we have two subsets of the synthetic datasets placed at：
```bash
./data/datasets/invInst
```
For complete datasets please visit: https://huggingface.co/datasets/ChrisWang233/recAtk_InvInst.
